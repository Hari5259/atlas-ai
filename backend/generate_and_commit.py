...
Partitioned into 18 chunks, written to json files, and committed.
"""
...
def main():
    ...
    # Partitions (18 chunks, distributed evenly)
    num_chunks = 18
    ...
    print(f"Success: {total_entries} entries generated and committed in 18 distinct commits!")
